...
import './DoctorFeedback.css'; // Make sure the CSS file is named correctly
...
const pastFeedback = [
  {
    ...
    rating: 5,
    comment:
      'Dr. Reed was extremely attentive and answered all of my questions thoroughly. I felt very well-cared for.',
  },
  {
    id: 2,
    date: '2025-06-02',
    ...
    rating: 4,
    comment:
      'Booking the appointment online was easy, but I had to wait about 20 minutes past my scheduled time.',
  },
  {
    id: 3,
    date: '2025-02-10',
    ...
    rating: 5,
    comment:
      'The clinic is very clean and modern. A comfortable and professional environment.',
  },
  {
    id: 4,
    date: '2025-08-15',
          ...
          pastFeedback.map((fb) => (
            <div key={fb.id} className="feedback-item-card">
              <div className="feedback-item-header">
                <span className="feedback-category">{fb.patientName}</span>
